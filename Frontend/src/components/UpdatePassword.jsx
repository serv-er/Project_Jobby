...
import { clearAllUpdateProfileErrors, updatePassword } from '../store/slices/updateSlice';
  ...
  return (
   <div className="account_components update_password_component">
    ...
    <div className='save_change_btn_wrapper'>
        <button className='btn' onClick={handlePassword} disabled={loading}>Update Password</button>
    </div>
   </div>
  )
}
